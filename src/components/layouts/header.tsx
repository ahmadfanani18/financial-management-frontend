      ...
      <div className="flex items-center gap-2">
        ...
        <DropdownMenu>
          ...
          <DropdownMenuContent align="end" className="w-80">
            ...
            <DropdownMenuSeparator />
            <DropdownMenuItem className="justify-center text-primary" onClick={() => window.location.href = '/dashboard/notifications'}>Lihat semua notifikasi</DropdownMenuItem>
          </DropdownMenuContent>
        </DropdownMenu>
        ...
        <DropdownMenu>
          ...
          <DropdownMenuContent align="end" className="w-56">
            ...
            <DropdownMenuSeparator />
            <DropdownMenuItem onClick={logout} className="text-destructive focus:text-destructive"><LogOut className="mr-2 h-4 w-4" />Keluar</DropdownMenuItem>
          </DropdownMenuContent>
        </DropdownMenu>
      </div>
    </header>
